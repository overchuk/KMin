...
if (dom)
{
	document.write("<style type=\"text/css\">.table-style{font-family: arial;border:1px solid #a0a0a0; background-color: #ffffff; font-size: 11px;}\n");
	document.write(".div-style{z-index: +998; position: absolute; visibility: hidden;}\n");
	document.write(".title-style{padding: 0px;font-family: arial;font-size: 11px;color: #000000;}\n");
	document.write(".title-background-style {background-color: #EDEDE1;	}\n");
	document.write(".title-control-normal-style {font-weight: bold; cursor: pointer;}\n");
	document.write(".body-style {padding: 0px; background-color: #FFFFFF; font-family: verdana; font-size: 10px;}\n");
	document.write("A.current-day-style {color: red; font-weight: bold; text-decoration: none;}\n");
	document.write("A.end-of-weekday-style {color: #909090; text-decoration: none;}\n");
	document.write("A.normal-day-style {color: black; text-decoration: none;}\n");
	document.write("A.selected-day-style { border-style: solid; border-width: 1px; border-color: #a0a0a0;}\n");
...
function DateSelectorInit()	{
	if (!ns4)
	{
		...
		sHTML1 += " <td align=center><span id='spanMonth' class='title-control-normal-style'></span></td>\n";
		sHTML1 += "	<td width='5'><span id='spanRight' class='title-control-normal-style' onclick='javascript:incMonth()'>&gt;</span></td>\n";
		sHTML1 += "	<td><span onClick='javascript:setToday();' class='title-control-normal-style'><pre>| Сегодня |<pre></span></td>\n";
		sHTML1 += "	<td width='5'><span id='spanLeft' class='title-control-normal-style' onclick='javascript:decYear()'>&lt;</span></td>\n";
		sHTML1 += " <td align=center><span id='spanYear' class='title-control-normal-style'></span></td>\n";
		sHTML1 += "	<td width='5'><span id='spanRight' class='title-control-normal-style' onclick='javascript:incYear()'>&gt;</span></td>\n";
		sHTML1 += "</tr>\n";
		sHTML1 += "</table>\n";
